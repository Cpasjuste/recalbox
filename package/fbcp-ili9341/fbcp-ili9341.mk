...
FBCP_ILI9341_CONF_OPTS = -DBUILDROOT=ON -DARMV8A=ON -DFREEPLAYTECH_WAVESHARE32B=ON -DSPI_BUS_CLOCK_DIVISOR=6 -DDMA_TX_CHANNEL=7 -DDMA_RX_CHANNEL=5 -DSTATISTICS=0
