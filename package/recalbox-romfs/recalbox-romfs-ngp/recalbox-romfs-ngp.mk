...
# ./scripts/linux/empack.py --system ngp --extension '.ngc .NGC .ngp .NGP .zip .ZIP .7z .7Z' --fullname 'Neo-Geo Pocket' --platform ngp --theme ngp libretro:mednafen_ngp:BR2_PACKAGE_LIBRETRO_BEETLE_NGP
...
define CONFIGURE_MAIN_NGP_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_NGP),Neo-Geo Pocket,$(SYSTEM_NAME_NGP),.ngc .NGC .ngp .NGP .zip .ZIP .7z .7Z,ngp,ngp)
endef
