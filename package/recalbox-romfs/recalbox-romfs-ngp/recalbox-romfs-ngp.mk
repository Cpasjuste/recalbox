...
# ./scripts/linux/empack.py --system ngp --extension '.ngc .NGC .ngp .NGP .npc .NPC .zip .ZIP .7z .7Z' --fullname 'Neo-Geo Pocket' --platform ngp --theme ngp libretro:mednafen_ngp:BR2_PACKAGE_LIBRETRO_BEETLE_NGP
