...
# ./scripts/linux/empack.py --system vectrex --extension '.vec .VEC .bin .BIN .zip .ZIP .7z .7Z' --fullname 'Vectrex' --platform vectrex --theme vectrex libretro:vecx:BR2_PACKAGE_LIBRETRO_VECX
