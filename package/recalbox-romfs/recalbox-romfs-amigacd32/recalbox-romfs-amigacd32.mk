...
# ./scripts/linux/empack.py --system amigacd32 --extension '.uae .cue .CUE .iso .ISO .zip .ZIP' --fullname 'Amiga CD32' --platform amiga --theme amigacd32 BR2_PACKAGE_AMIBERRY
...
define CONFIGURE_AMIGACD32
	$(call RECALBOX_ROMFS_CALL_ADD_STANDALONE_SYSTEM,$(SYSTEM_XML_AMIGACD32),Amiga CD32,$(SYSTEM_NAME_AMIGACD32),.uae .cue .CUE .iso .ISO .zip .ZIP,amiga,amigacd32,$(SOURCE_ROMDIR_AMIGACD32),$(@D))
endef
