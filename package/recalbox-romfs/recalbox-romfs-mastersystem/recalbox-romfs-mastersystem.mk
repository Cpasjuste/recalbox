...
# ./scripts/linux/empack.py --system mastersystem --extension '.sms .SMS .zip .ZIP .7z .7Z' --fullname 'Sega Master System / Mark III' --platform mastersystem --theme mastersystem libretro:genesisplusgx:BR2_PACKAGE_LIBRETRO_GENESISPLUSGX libretro:picodrive:BR2_PACKAGE_LIBRETRO_PICODRIVE libretro:gearsystem:BR2_PACKAGE_LIBRETRO_GEARSYSTEM
...
define CONFIGURE_MASTERSYSTEM_LIBRETRO_GEARSYSTEM_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),gearsystem)
endef
endif
