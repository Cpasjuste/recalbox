...
define CONFIGURE_AMIGA600
	$(call RECALBOX_ROMFS_CALL_ADD_STANDALONE_SYSTEM,$(SYSTEM_XML_AMIGA600),Amiga 600,$(SYSTEM_NAME_AMIGA600),.adf .Adf .ADF .uae,amiga,amiga600,$(SOURCE_ROMDIR_AMIGA600),$(@D))
endef
