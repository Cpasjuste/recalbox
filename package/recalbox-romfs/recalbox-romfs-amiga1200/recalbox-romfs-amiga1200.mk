...
define CONFIGURE_AMIGA1200
	$(call RECALBOX_ROMFS_CALL_ADD_STANDALONE_SYSTEM,$(SYSTEM_XML_AMIGA1200),Amiga 1200,$(SYSTEM_NAME_AMIGA1200),.adf .Adf .ADF .uae,amiga,amiga1200,$(SOURCE_ROMDIR_AMIGA1200),$(@D))
endef
