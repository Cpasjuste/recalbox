...
# ./scripts/linux/empack.py --system virtualboy --extension '.vb .VB .vboy .VBOY .bin .BIN .zip .ZIP .7z .7Z' --fullname 'Virtual Boy' --platform virtualboy --theme virtualboy libretro:mednafen_vb:BR2_PACKAGE_LIBRETRO_BEETLE_VB
