...
define CONFIGURE_PISNES_START
	$(call RECALBOX_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_SNES),pisnes)
endef
define CONFIGURE_PISNES_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),pisnes)
endef
define CONFIGURE_PISNES_END
	$(call RECALBOX_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_SNES))
endef
endif
...
define RECALBOX_ROMFS_SNES_CONFIGURE_CMDS
	...
	$(CONFIGURE_PISNES_START)
	$(CONFIGURE_PISNES_DEF)
	$(CONFIGURE_PISNES_END)
