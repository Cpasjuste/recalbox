...
define CONFIGURE_IMAGEVIEWER
	$(call RECALBOX_ROMFS_CALL_ADD_STANDALONE_SYSTEM_FULLPATH,$(SYSTEM_XML_IMAGEVIEWER),Screenshots,$(SYSTEM_NAME_IMAGEVIEWER),.jpg .jpeg .png .bmp .psd .tga .gif .hdr .pic .ppm .pgm .JPG .JPEG .PNG .BMP .PSD .TGA .GIF .HDR .PIC .PPM .PGM",ignore,imageviewer,$(SOURCE_ROMDIR_IMAGEVIEWER),$(@D),/recalbox/share/screenshots)
endef
